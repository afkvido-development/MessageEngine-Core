# Contributing to MessageEngine Core
...
### Star the repository
Join the [stargazers](https://github.com/afkvido-development/MessageEngine-Core/stargazers) of MessageEngine Core to support the repository!
_(Reward: **Stargazer** role in our [discord server](https://disboard.org/server/893975758677086238))_

### Watch the repository
Join the [watchers](https://github.com/afkvido-development/MessageEngine-Core/watchers) of MessageEngine Core to see the latest activity in the repository!
...
Follow all the [contributors](https://github.com/afkvido-development/MessageEngine-Core/graphs/contributors) of this repository! They make the repository!
...
- MessageEngine Core is open to ALL pull requests as long as they are helpful (improve MessageEngine Core). We allow all types of MiniPRs as long as you follow our pull request guidelines.
...
- Any PRs we close without merging, we *probably* have reasons.
...
- `Version.java` - `src/msgCore/version/Version.java` - Don't change the version, we'll do this ourselves.
- `version.yml` - `src/msgCore/version/version.yml` -  Don't change the version, we'll do this ourselves. UNLESS this file isn't up-to-date with Version.java
...
### Make your edits
1. **[Fork this repository](https://github.com/afkvido-development/MessageEngine-Core/fork)**. You'll push your edits to your fork.
...
4. Once you've finished making your edits, make sure to **build the artifacts**. If you've done this successfully, `MessageEngine-Core.jar` (in `/build/MessageEngine-Core.jar`) will update.
...
1. **VERY IMPORTANT**: Please name your commits `MessageEngine Core`. You can type the info in the more details section.
